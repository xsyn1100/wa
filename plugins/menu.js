...
const sections = [
   {
	...
	rows: [
	    {title: ` ${pmenus} Donasi`, rowId: ".donasi", description: 'Donasi untuk owner bot'},
	]
	},{
	title: `${htki} ᴍᴇɴᴜ ${htka}`,
	rows: [
	    {title: ` ${pmenus} Anonymous Chats`, rowId: ".? anonymous", description: "Chat dengan orang random"},
	    {title: ` ${pmenus} Stikers`, rowId: ".? stiker", description: "Ubah foto jadi stiker"},
	{title: ` ${pmenus} nulis`, rowId: ".? nulis", description: "Bot nulis"},
	...
	{title: ` ${pmenus} Anime`, rowId: ".? anime", description: "Wibu wibu🐦"},
